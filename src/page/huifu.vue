...
<script>
  ...
  import huifuBoard from '../components/huifuBoard'
  ...
  export default {
    ...
    // }
    // mounted(){
    //       document.getElementsByClassName('el-menu')[1].children[3].click();
    //       console.log(this.$route);
    //       if(this.$route.path=='/huifu'){
    //         console.log(1);
    //         this.changeRoute('huifu');
    //         this.changeRoute('huifu');
    //       }
    //     },
    //     watch:{
    //       $route(){
    //         if(this.$route.path=='/huifu'){
    //           document.getElementsByClassName('el-menu')[3].children[3].click();
    //         }
    //   }
    // }
  }
