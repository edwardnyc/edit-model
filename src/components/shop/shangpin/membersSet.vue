  ...
  <div>
    <div v-if="name==='jifen'">
      ...
      { type: 'number', message: '内容必须为数字值'}
          ...
          <el-button type="primary" v-on:click="" style="border: 0;background-color:#f1f2f6;color: #409EFF;position: absolute;top: 5px;right:120px">刷新</el-button>
          <el-button type="primary" v-on:click="" style="border: 0;background-color:#f1f2f6;color: #409EFF;position: absolute;top: 5px;right:50px">新增</el-button>
          <el-dropdown trigger="click" style="position: relative">
      <span class="el-dropdown-link" style=" border: 0;background-color:#f1f2f6;color: #409EFF;position: absolute;top: -66px;right:-810px">
        收起模板
      </span>
